...
handle Bluetooth (original version of pybluez doesn't work now so it uses [fork](https://github.com/AcrossTheCloud/pybluez)), and [bluepy](https://github.com/IanHarvey/bluepy) to handle
